...
if (typeof DEFAULT_PRODUCTS_DATA === 'undefined') {
  var DEFAULT_PRODUCTS_DATA = (typeof window !== 'undefined' && window.DEFAULT_PRODUCTS_DATA) ? window.DEFAULT_PRODUCTS_DATA : [];
}
if (typeof DEFAULT_JOBS_DATA === 'undefined') {
  var DEFAULT_JOBS_DATA = (typeof window !== 'undefined' && window.DEFAULT_JOBS_DATA) ? window.DEFAULT_JOBS_DATA : [];
}
